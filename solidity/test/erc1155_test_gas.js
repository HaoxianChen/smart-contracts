...
const testPath = path.join(__dirname, '../tracefiles/erc1155/setup.txt');
...
var ERC1155 = artifacts.require(contractName);
          ...
          if(line != '') {
            ...
            if(eachLineArr[1] == 'constructor') {
              if(fromAccountIndex != -1 && valueTran!= -1) {
                ...
                instance = await ERC1155.new(...argArr, {from: accounts[fromAccountIndex], value: valueTran});
              } else if(fromAccountIndex != -1) {
                // console.log('from ');
                instance = await ERC1155.new(...argArr, {from: accounts[fromAccountIndex]});
              } else if(valueTran != -1) {
                // console.log('value');
                instance = await ERC1155.new(...argArr, {value: valueTran});
              } else {
                // console.log('neither from + value');
                instance = await ERC1155.new(...argArr);
              }  
            }
            // call transaction
