...
helper.range(transactionCounts).forEach(l => {
  ...
  if(transactionName == 'getOwnerOf') {
    ...
    helper.range(tracefileCount).forEach(testFileIndex => {
      ...
      let mintAmount_1 = helper.random(lowerBound, upperBound+1);
      let mintAmount_2 = helper.random(lowerBound, upperBound+1);
      let text = `getOwnerOf,constructor,,,${owner},,false\ngetOwnerOf,mint,instance,${tokenId} accounts[${mintAccountIndex}],${owner},,false\ngetOwnerOf,getOwnerOf,instance,${tokenId},,,false\ngetOwnerOf,mint,instance,${tokenId+1} accounts[${mintAccountIndex}],${owner},,false\ngetOwnerOf,getOwnerOf,instance,${tokenId+1},,,true\n`;
